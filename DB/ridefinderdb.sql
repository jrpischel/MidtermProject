...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `nickname`, `photo_url`, `description`, `shared`, `last_name`, `address_id`, `create_date`, `last_update`) VALUES (4, 'Punisher', 'password', 1, NULL, 'Frank', 'Punisher', 'https://oyster.ignimgs.com/wordpress/stg.ign.com/2017/11/dolph-lundgren-the-punisher.jpg?fit=bounds&width=1280&height=720', 'Live to ride, ride to live.', 1, 'Castle', 4, '2023/02/04', '2023/09/18');
...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `nickname`, `photo_url`, `description`, `shared`, `last_name`, `address_id`, `create_date`, `last_update`) VALUES (8, 'Snake', 'password', 1, NULL, 'Snake', 'Snake', 'https://i.redd.it/kwwkgu55tat71.jpg', 'Hey everybody!', 1, 'Plissken', 2, '2023/02/24', '2023/06/14');
...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `nickname`, `photo_url`, `description`, `shared`, `last_name`, `address_id`, `create_date`, `last_update`) VALUES (14, 'DK', 'password', 1, NULL, 'Donkey', 'DK', 'https://i5.walmartimages.com/asr/9edb5420-5a79-4b31-a5fa-369ee6677d83_1.b696ae1492b9137c90af6fd1571d3a0e.jpeg?odnHeight=640&odnWidth=640&odnBg=FFFFFF', 'Banana slamma!!', 1, 'Kong', 1, '2023/06/24', '2023/07/21');
